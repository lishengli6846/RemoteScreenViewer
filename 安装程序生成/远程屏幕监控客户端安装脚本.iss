...
[Icons]
Name: "{group}\远程屏幕监控客户端"; Filename: "{app}\RemoteScreenViewer.exe"
Name: "{group}\{cm:UninstallProgram,远程屏幕监控客户端}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\远程屏幕监控客户端"; Filename: "{app}\RemoteScreenViewer.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\RemoteScreenViewer.exe"; Description: "{cm:LaunchProgram,远程屏幕监控客户端}"; Flags: nowait postinstall skipifsilent
